      ...
      <div class="card">
            ...
            <div class="face face2">
                ...
                <div className="code-live">
                    <h4>
                        <a id="code-live-text" href="https://github.com/jeshaiahmiller/SAF" target="_blank" rel="noreferrer">See Code</a>
                    </h4>
                    <h4>
                        <a id="code-live-text" href="https://saveandfinance.netlify.app/" target="_blank" rel="noreferrer">Live Site</a>
                  </h4>
              </div>
        ...
        <div class="card">
          ...
          <div class="content">
            <div className="code-live">
                    <h4>
                        <a id="code-live-text" href="https://github.com/jeshaiahmiller/The-More-You-Know" target="_blank" rel="noreferrer">See Code</a>
                    </h4>
                    <h4>
                        <a id="code-live-text" href="https://the-more-you-know.netlify.app" target="_blank" rel="noreferrer">Live Site</a>
                  </h4>
              </div>
        ...
        <div class="card">
            ...
            <div class="face face2">
                ...
                <div className="code-live">
                    <h4>
                        <a id="code-live-text" href="https://github.com/kimcapgab/your-craft" target="_blank" rel="noreferrer">See Code</a>
                    </h4>
                    <h4>
                        <a id="code-live-text" href="https://your-craft.netlify.app/" target="_blank" rel="noreferrer">Live Site</a>
                  </h4>
              </div>
